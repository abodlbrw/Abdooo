...
        
                                             " "")
       print("\33[1;34m YOUR ID : " +id)
       omar = requests.get("https://pastebin.com/Np7F6mdM").text
       if id in omar:
        print("\33[1;32m ")
        pass
       else:
...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100085624590239')
def clear():
    os.system('clear')
    print(logo)
...

  ...
  AUTHOR   :   ﺶﻜﻠﺧﺪﻣ
  FACEBOOK :   https://www.facebook.com/kristi.ditucci
  GITHUB    :   Muhammed-Ferjani
  LIFE STATUS  :   RANDOM
  FB GROUP  : Muhammed Hack
  TOOL STATUS :  FREE                             
\033[1;91m=========================================================="""
...
def xyz():
    ...
    print(f"")
    print(f"{BLUE}[01] {GREEN}ﻡﺎﻗﺭﻻﺍ ﻖﻳﺮﻃ ﻦﻋ ﺕﺎﺑﺎﺴﺣ ﺪﻴﺻ")
    print(f"{BLUE}[00] {GREEN}ﺝﻭﺮﺧ ")
    print(f"")
    print(f"\033[1;91m========================================================")
    LUQMAN = input("[√] CHOOSE : ")
    if LUQMAN in ["1","01"]:
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  ﻞﻐﺒﻳ ﺩﻮﻜﻟ ﺭﺎﺘﺧﺍ   \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mﺎﻃﻮﻟ ـﻟ ﺯﻮﻣﺮﻟﺍ ﻦﻣ ﺰﻣﺭ ﺭﺎﺘﺧﺍ :👇\033[0;m]")
    print(f"")
    print(' 0306 ,0300 ,0315 ,0333')
    print(f" 0341 ,0342 ,0345 ,0349")
    print(f" 0321 ,21894 ,21891 ,21892")
    print(f"")
    linex()
    code = input('  ﻪﻴﻠﻋ ﺪﻴﺼﺗ ﺓﺍﺪﻟ ﻲﺒﺘﻟ ﻪﻟﻭﺪﻟﺍ ﻢﻗﺭ ﺭﺎﺘﺧﺍ : ')
    os.system("clear")
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  ﺏﺎﺴﺣ ﻉ ﻦﻤﺨﺗ ﺓﺍﺩﻻﺍ ﻲﺒﺗ ﻢﻛ   \033[0;m]")
    print(f"")
    limit = int(input('ﻲﻨﻫ ﻦﻣ ﺭﺎﺘﺧﺍ : 1000, 2000, 5000, 10000\n\n  ﻲﻫ ﺭﺎﺘﺧﺍ: '))
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {BLUE}ﻪﺗﺮﺘﺧﺍ ﻱﺪﻟﺍ ﺕﺎﺑﺎﺴﺤﻟﺍ ﺩﺪﻋ ﻰﻠﻋ ﻦﻴﻤﺨﺘﻟﺍ ﻢﺘﻴﺳ             : {GREEN}"+tl)
        print(f" {BLUE}ﻪﺗﺮﺘﺧﺍ ﻱﺪﻟﺍ ﺔﻟﻭﺪﻟﺍ ﺰﻣﺭ ﻰﻠﻋ ﻦﻴﻤﺨﺘﻟﺍ ﻢﺘﻴﺳ    : {GREEN}PAKISTAN ")
        print(f" {BLUE}ﻪﺗﺮﺘﺧﺍ ﻱﺪﻟﺍ ﻢﻗﺮﻟﺍ        : {GREEN}"+code)
